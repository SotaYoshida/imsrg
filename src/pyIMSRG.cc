...
PYBIND11_MODULE(pyIMSRG, m)
{
  m.doc() = "python bindings for IMSRG code";
   ...
   py::class_<ModelSpace>(m,"ModelSpace")
      ...
      .def(py::init< int, int, int, std::vector<std::string>,std::vector<std::string> >())
      .def(py::init< int, int, int, std::vector<std::string>,std::vector<std::string>,std::vector<std::string> >())
