...
PYBIND11_MODULE(pyIMSRG, m)
{
  m.doc() = "python bindings for IMSRG code";
   ...
   py::class_<ModelSpace>(m,"ModelSpace")
      ...
      .def(py::init< int,int,int, const std::string&>(),  py::arg("emax"),py::arg("e2max"),py::arg("e3max"),py::arg("reference") )
      .def(py::init< int,int,int, const std::string&, const std::string&>(),  py::arg("emax"),py::arg("e2max"),py::arg("e3max"),py::arg("reference"),py::arg("valence"))
      .def(py::init< int,int,int,std::vector<std::string>,std::vector<std::string> >(), py::arg("emax"),py::arg("e2max"),py::arg("e3max"),py::arg("hole_list"),py::arg("valence_list"))
      .def(py::init< int,int,int,std::vector<std::string>,std::vector<std::string>,std::vector<std::string> >(), py::arg("emax"),py::arg("e2max"),py::arg("e3max"),py::arg("hole_list"),py::arg("core_list"),py::arg("valence_list"))
